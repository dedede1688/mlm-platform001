...
const ChartsSection = dynamic(() => import('@/components/dashboard/ChartsSection'), {
  ...
  loading: () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
      <div className="card-base p-4 sm:p-5 h-56 animate-pulse bg-gray-50 rounded-xl" />
      <div className="card-base p-4 sm:p-5 h-56 animate-pulse bg-gray-50 rounded-xl" />
    </div>
  ),
})
...
function DashboardSection({ data }: { data: DashboardData }) {
  ...
  return (
    <div className="mb-6 sm:mb-8">
      ...
      {/* ???? + ??????? recharts? */}
      <ChartsSection data={{ categoryBreakdown, trend, pieHasData, trendHasData, totalMonthAmount }} />
