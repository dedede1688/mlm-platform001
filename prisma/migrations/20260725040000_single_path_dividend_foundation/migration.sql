-- Batch 3A-2 Task 1: Single-Path Dividend Foundation
...
ALTER TABLE "orders" ADD COLUMN "reward_last_attempt_at" TIMESTAMPTZ;
ALTER TABLE "orders" ADD COLUMN "rewards_completed_at" TIMESTAMPTZ;
...
ALTER TABLE "dividends" ADD COLUMN "refunded_at" TIMESTAMPTZ;
CREATE UNIQUE INDEX "dividends_orderId_userId_poolType_key" ON "dividends"("order_id", "user_id", "pool_type");

-- 6. Add nullable reward idempotency_key, backfill from existing record IDs, then set NOT NULL + unique
ALTER TABLE "rewards" ADD COLUMN "idempotency_key" TEXT;
UPDATE "rewards" SET "idempotency_key" = "id";
